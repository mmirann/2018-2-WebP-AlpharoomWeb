...
try{
	...
	String sql= "select max(id) as max_id from lostnfound_tbl";
	...
	sql_update="insert into lostnfound_tbl values ("+new_id+","+"'"+session.getAttribute("sessionName")+"'"+","+"'"+title+"'"+","+"'"+content+"'"+","+ref+","+"'"+password+"'"+","+now+")";
