...
int id=0,ref=0;
int new_id=0;
String name,title,content,reply,password,student_number,times;
...
try{
	...
	String sql= "select max(id) as max_id from caution_tbl";
	...
	sql_update="insert into caution_tbl values ("+new_id+","+"'"+name+"'"+","+"'"+student_number+"'"+","+"'"+times+"'"+")";
