...
<br>
	...
	</div><div style="height:488px">
<form action="Q&A_delete.jsp" method="post">
...
try{
	...
	sql="select * from caution_tbl where id="+id;
...
while(rs.next())
{
		sql1="delete from caution_tbl where id="+id;
		stmt.executeUpdate(sql1);%>
		
		<center><h2>게시글이 삭제되었습니다.</h2>
			<input type="button" class="my_button" value="목록" onclick="location.href='caution.jsp'"/></center></div>
		<div id="underbar">
