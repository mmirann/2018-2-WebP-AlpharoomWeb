...
<body>
	...
	<div id="top">
		...
		<iframe src="login_menu.jsp"
			style="width: 250px; height: 32.5px; border: 0" scrolling="no"></iframe>
		<img src="image/seat_no.png" width="260" height="50">
		<button type="button" class="button_other"
			onclick="location.href='join.jsp'">회원가입</button>
		<button type="button" class="button_other"
			onclick="location.href='alpha.html'">HOME</button>
		<button type="button" class="button_other"
			onclick="location.href='http://www.dongguk.edu/'">DGU</button>
	</div>
	...
	<div style="height: 488px">
		<img src="image/seat_no.png" width="260" height="10"> <font
			size="5">분실물센터 </font> <font size="1"></font> <br>
		<br>
		...
		<table align="center" width="1000px" cellpadding="0" cellspacing="0"
			...
			<%
				...
				try {
					...
					sql = "select * from lostnfound_tbl order by ref desc, id asc";
			...
			<tr height="25" align="center">
				...
				<td>
					<%
						if (id != ref)
								out.println("⤷");
					%><a href=lost&found_read.jsp?id=<%=rs.getString("id")%>><%=rs.getString("title")%></a>
				</td>
		...
		<center>
			<input type="button" class="my_button" value="글쓰기"
				onclick="location.href='lost&found_insert.jsp'">
		</center>
		<%
			stmt.close();
			conn.close();
	...
	<div id="underbar">
		<img id="logo_white" src="image/logo_white.png"><font
			color="white" size="2.5"><br>
		<br>&nbsp;&nbsp;&nbsp;서울특별시 중구 필동로 1길 30(우 04620))<br>&nbsp;&nbsp;&nbsp;Copyright
			ⓒ 2018 BY DONGGUK UNIVERSITY ALL RIGHTS RESERVED.</font>
	</div>
