...
try{
	...
	String sql= "select * from lostnfound_tbl where id="+id;
...
<br>
<div style="border: 1px solid #eeeeee; width:900px; position:relative; margin-left:250px;height: auto; padding:10px;">
<%

String path=(String)session.getAttribute("sessionFileRealName");
 %>
<input type="image" src="/projectFinal/upload/<%=path%>">
<%=content.replace("\r\n", "<br>") %></div>
<p>
<div style="position:relative; margin-left:700px">
 <input type="button" class="my_button" value="답글" onclick="location.href='lost&found_insert.jsp?ref=<%=ref%>&flag=r'"/>
<input type="button" class="my_button" value="목록" onclick="location.href='lost&found.jsp'"/>
<input type="button" class="my_button" value="수정" onclick="location.href='lost&found_modify_pw.jsp?id=<%=id%>'"/>
<input type="button" class="my_button" value="삭제" onclick="location.href='lost&found_delete_pw.jsp?id=<%=id%>'"/>
</div>
</div>
<div id="underbar">
