...
<br>
	...
	<br>	<div style="height:488px">
<br><br><br><br><br>
<center>
<h2>비밀번호를 입력하시오.</h2><p>
<form action="Q&A_delete_db.jsp" method="post">
<table border=0>
<tr>
<td> 비밀번호 : </td>
...
<input type="button" class="mybutton" value="수정취소" onclick="location.href='notice_read.jsp?id=<%=request.getParameter("id")%>'">
</form>
