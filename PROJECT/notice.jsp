...
<td>[공지]</td>
<td><a href=notice_read.jsp?id=<%=rs.getString("id")%>><%=rs.getString("title") %></a></td>
...
<center>
 <%
  ...
  if(my_id.equals("admin")){ %>
    <input type="button" id="write" class="my_button" value="글쓰기" onclick="location.href='notice_insert.jsp'"/>
  <%} }%>
</center>
</div>
<% stmt.close();
